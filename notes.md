...
|--------------------|---------|--------------|-----------------|----------|---------------|------------------|
| TF-IDF             | 40.0%   | 0.381        | 0.386           | 37.8%    | 0.330         | 0.358            |
| DAN                | 38.1%   | 0.321        | 0.351           | 34.6%    | 0.303         | 0.320            |
| DAN+TF-IDF Hybrid  | 34.9%   | 0.345        | 0.355           | 32.9%    | 0.307         | 0.328            |
| Argument Features  | 20.2%   | 0.191        | 0.194           | 15.9%    | 0.144         | 0.144            |
| TF-IDF + Argument  | 39.6%   | 0.387        | 0.400           | 39.3%    | 0.372         | 0.392            |
...
| Model             | Dev Acc | Dev Macro F1 | Dev Weighted F1 | Test Acc | Test Macro F1 | Test Weighted F1 |
|-------------------|---------|--------------|-----------------|----------|---------------|------------------|
| TF-IDF            | 57.4%   | 0.503        | 0.542           | 53.7%    | 0.402         | 0.506            |
| DAN               | 62.5%   | 0.519        | 0.600           | 56.2%    | 0.430         | 0.534            |
| DAN+TF-IDF Hybrid | 52.8%   | 0.502        | 0.536           | 51.7%    | 0.477         | 0.530            |
| Argument Features | 38.4%   | 0.363        | 0.396           | 28.9%    | 0.265         | 0.303            |
| TF-IDF + Argument | 53.2%   | 0.495        | 0.530           | 54.2%    | 0.484         | 0.543            |

## 7 informal fallacies

| Model             | Dev Acc | Dev Macro F1 | Dev Weighted F1 | Test Acc | Test Macro F1 | Test Weighted F1 |
|-------------------|---------|--------------|-----------------|----------|---------------|------------------|
| TF-IDF            | 49.4%   | 0.427        | 0.463           | 46.5%    | 0.436         | 0.442            |
| DAN               | 48.0%   | 0.420        | 0.448           | 46.5%    | 0.431         | 0.429            |
| DAN+TF-IDF Hybrid | 39.0%   | 0.384        | 0.409           | 42.3%    | 0.437         | 0.429            |
| Argument Features | 26.6%   | 0.242        | 0.262           | 25.5%    | 0.244         | 0.243            |
| TF-IDF + Argument | 48.0%   | 0.451        | 0.477           | 48.1%    | 0.481         | 0.475            |
