...
def main():
    ...
    print(
        f"Train: {len(train_texts)}, Dev: {len(dev_texts)}, Test: {len(test_texts)}, Classes: {num_classes}"
    )
    ...
    train_loader = DataLoader(
        FallacyDataset(train_enc, train_y), batch_size=BATCH_SIZE, shuffle=True
    )
    dev_loader = DataLoader(
        FallacyDataset(dev_enc, dev_y), batch_size=BATCH_SIZE, shuffle=False
    )
    test_loader = DataLoader(
        FallacyDataset(test_enc, test_y), batch_size=BATCH_SIZE, shuffle=False
    )
